...
public class EquipmentOrder {
	...
	public ResponseEntity<?> createAirportDetails(
		...
		reqValidator.validateRequestParameters(productordercreaterequest);
		ResponseBean<ProductOrder> response = equipmentorderservice.updateequipmentorder(productordercreaterequest);
