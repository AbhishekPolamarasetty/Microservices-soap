...
/**
 * <p>Java class for CallStatusType.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * <p>
 * <pre>
 * &lt;simpleType name="CallStatusType">
 ...
 * 
 */
@XmlType(name = "CallStatusType", namespace = "http://mdsuk.com/ws/dise3g/billing/dto/business")
@XmlEnum
public enum CallStatusType {
    ...
    public static CallStatusType fromValue(String v) {
        for (CallStatusType c: CallStatusType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
