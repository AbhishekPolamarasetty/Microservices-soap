 ...
 * 
 */
@WebFault(name = "ValidationFault", targetNamespace = "http://mdsuk.com/ws/dise3g/fault/definition")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.bt.ms.im.cmp.createorder.entity.ValidationFault
     */
