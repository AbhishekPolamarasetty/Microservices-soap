...
/**
 * This structure optionally posted as part of the Update Account request
 * 
 * <p>Java class for UpdateAutoPaymentsType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UpdateAutoPaymentsType">
 *   &lt;complexContent>
 ...
 *         &lt;element name="SuspendUpToDueDate" type="{http://mdsuk.com/ws/dise3g/base}ClearableDateType" minOccurs="0"/>
 *         &lt;element name="SuspendDueDateUntil" type="{http://mdsuk.com/ws/dise3g/base}ClearableDateType" minOccurs="0"/>
...
@XmlType(name = "UpdateAutoPaymentsType", namespace = "http://mdsuk.com/ws/dise3g/account/dto/business", propOrder = {

})
public class UpdateAutoPaymentsType {
    ...
    protected ClearableDateType suspendUpToDueDate;
    @XmlElement(name = "SuspendDueDateUntil")
    protected ClearableDateType suspendDueDateUntil;
     ...
     *     
     */
    public ClearableDateType getSuspendUpToDueDate() {
     ...
     *     
     */
    public void setSuspendUpToDueDate(ClearableDateType value) {
     ...
     *     
     */
    public ClearableDateType getSuspendDueDateUntil() {
     ...
     *     
     */
    public void setSuspendDueDateUntil(ClearableDateType value) {
